...
//frappe.ui.form.on('Button', "refresh", function(frm) {
			...
			frappe.ui.form.on("Button", "button", function(frm){

						/*alert("hi");
						var myWin = window.open('https://tympanix.github.io/pattern-lock-js/');*/
